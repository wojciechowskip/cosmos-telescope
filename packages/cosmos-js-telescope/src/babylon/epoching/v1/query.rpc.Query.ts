...
import { QueryParamsRequest, QueryParamsResponse, QueryEpochInfoRequest, QueryEpochInfoResponse, QueryEpochsInfoRequest, QueryEpochsInfoResponse, QueryCurrentEpochRequest, QueryCurrentEpochResponse, QueryEpochMsgsRequest, QueryEpochMsgsResponse, QueryLatestEpochMsgsRequest, QueryLatestEpochMsgsResponse, QueryValidatorLifecycleRequest, QueryValidatorLifecycleResponse, QueryDelegationLifecycleRequest, QueryDelegationLifecycleResponse, QueryEpochValSetRequest, QueryEpochValSetResponse } from "./query";
...
export class QueryClientImpl implements Query {
  ...
  epochsInfo(request: QueryEpochsInfoRequest = {
