...
export type PoolDataEncoded = Omit<PoolData, "pool"> & {
  /** pool struct */pool?: Pool1ProtoMsg | Pool2ProtoMsg | Pool3ProtoMsg | AnyProtoMsg | undefined;
};
/**
 * PoolData represents a serialized pool along with its ticks
 * for genesis state.
...
export const PositionData = {
  ...
  toJSON(message: PositionData): JsonSafe<PositionData> {
    const obj: any = {};
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      incentivesAccumulatorPoolIdMigrationThreshold: isSet(object.incentivesAccumulatorPoolIdMigrationThreshold) ? BigInt(object.incentivesAccumulatorPoolIdMigrationThreshold.toString()) : BigInt(0),
      spreadFactorPoolIdMigrationThreshold: isSet(object.spreadFactorPoolIdMigrationThreshold) ? BigInt(object.spreadFactorPoolIdMigrationThreshold.toString()) : BigInt(0)
    };
  },
  toJSON(message: GenesisState): JsonSafe<GenesisState> {
    ...
    message.incentivesAccumulatorPoolIdMigrationThreshold !== undefined && (obj.incentivesAccumulatorPoolIdMigrationThreshold = (message.incentivesAccumulatorPoolIdMigrationThreshold || BigInt(0)).toString());
    message.spreadFactorPoolIdMigrationThreshold !== undefined && (obj.spreadFactorPoolIdMigrationThreshold = (message.spreadFactorPoolIdMigrationThreshold || BigInt(0)).toString());
    return obj;
  },
