...
export const CreateConcentratedLiquidityPoolsProposal = {
  ...
  toJSON(message: CreateConcentratedLiquidityPoolsProposal): JsonSafe<CreateConcentratedLiquidityPoolsProposal> {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<CreateConcentratedLiquidityPoolsProposal>, I>>(object: I): CreateConcentratedLiquidityPoolsProposal {
    const message = createBaseCreateConcentratedLiquidityPoolsProposal();
...
export const TickSpacingDecreaseProposal = {
  ...
  toJSON(message: TickSpacingDecreaseProposal): JsonSafe<TickSpacingDecreaseProposal> {
    const obj: any = {};
    message.title !== undefined && (obj.title = message.title);
    message.description !== undefined && (obj.description = message.description);
...
export const PoolIdToTickSpacingRecord = {
  ...
  toJSON(message: PoolIdToTickSpacingRecord): JsonSafe<PoolIdToTickSpacingRecord> {
    const obj: any = {};
