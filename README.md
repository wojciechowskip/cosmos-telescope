...
<p align="center" width="100%">
  <a href="https://github.com/wojciechowskip/cosmos-js-telescope/actions/workflows/run-tests.yml">
    <img height="20" src="https://github.com/wojciechowskip/cosmos-js-telescope/actions/workflows/run-tests.yml/badge.svg" />
  </a>
...
```js
import { cosmwasm } from "cosmos-js-telescope";
...
```js
import { ibc } from 'cosmos-js-telescope';
...
Look inside of `scripts/codegen.ts` and configure the settings for bundling your SDK and contracts into `cosmos-js-telescope`:
